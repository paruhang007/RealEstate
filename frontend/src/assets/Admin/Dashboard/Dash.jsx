...
const LinkItems = [
  ...
  { name: "Properties", icon: BsHouses, path: "allproperties" },
  { name: "Users", icon: FiUsers, path: "allusers" },
  { name: "Services", icon: BsShopWindow, path: "allservices" },
  { name: "Grievance", icon: BiSupport, path: "grieverance" },
