...
export default function EditProperty() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (imageLink) {
      try {
        const response = fetch("http://localhost:4000/editPack", {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
          },
        ...
        if (!response.error) {
          ...
          toast({
            title: "Property did not updated successfully.",
            status: "error",
            duration: 3000,
            isClosable: true,
            position: "top-middle",
        ...
        >
          ...
          <HStack gap={5} align={"center"} mt={5}>
            <Box>
              ...
              >
                <option value="Rent" selected={product.selectedFor === "Rent"}>
                  Rent{" "}
                </option>
                <option value="Sale" selected={product.selectedFor === "Sale"}>
                  Sale{" "}
                </option>
                <option
                  value="Lease"
                  selected={product.selectedFor === "Lease"}
                >
                  Lease{" "}
                </option>
              </Select>
            ...
            <Box>
              ...
              >
                <option
                  value="Land"
                  selected={product.selectedPropertyType === "Land"}
                >
                  Land{" "}
                </option>
                <option
                  value="Flat"
                  selected={product.selectedPropertyType === "Flat"}
                >
                  Flat{" "}
                </option>
                <option
                  value="House"
                  selected={product.selectedPropertyType === "House"}
                >
                  House{" "}
                </option>
                <option
                  value="Apartment"
                  selected={product.selectedPropertyType === "Apartment"}
                >
                  Apartment{" "}
                </option>
                <option
                  value="Office space"
                  selected={product.selectedPropertyType === "Office space"}
                >
                  Office space{" "}
                </option>
                <option
                  value="Shop space"
                  selected={product.selectedPropertyType === "Shop space"}
                >
                  Shop space{" "}
                </option>
              </Select>
          ...
          <HStack gap={5} align={"center"} mt={5}>
            ...
            <Box>
              <FormControl id="district" isRequired>
                ...
                <Input
                  type="text"
                  defaultValue={product.propDist}
                  onChange={(e) =>
                    setProduct({ ...product, propDist: e.target.value })
                  }
                />
              </FormControl>
            </Box>
            <Box>
              <FormControl id="municipality" isRequired>
                ...
                <Input
                  type="text"
                  defaultValue={product.propMuni}
                  onChange={(e) =>
                    setProduct({ ...product, propMuni: e.target.value })
                  }
                />
              </FormControl>
            </Box>
            ...
            <Box>
              <FormControl id="ward" isRequired>
                ...
                <Input
                  type="text"
                  defaultValue={product.propWard}
                  onChange={(e) =>
                    setProduct({ ...product, propWard: e.target.value })
                  }
                />
              </FormControl>
            </Box>
            <Box>
              <FormControl id="tol" isRequired>
                ...
                <Input
                  type="text"
                  defaultValue={product.propStreet}
                  onChange={(e) =>
                    setProduct({ ...product, propStreet: e.target.value })
                  }
                />
              </FormControl>
            </Box>
          ...
          <HStack gap={5} align={"center"} mt={5}>
            <Box>
              <FormControl id="face" isRequired>
                ...
                <Input
                  type="text"
                  defaultValue={product.propFace}
                  onChange={(e) =>
                    setProduct({ ...product, propFace: e.target.value })
                  }
                />
              </FormControl>
            </Box>
            <Box>
              <FormControl id="road" isRequired>
                ...
                <Input
                  type="text"
                  defaultValue={product.propRoad}
                  onChange={(e) =>
                    setProduct({ ...product, propRoad: e.target.value })
                  }
                />
              </FormControl>
            </Box>
            <Box>
              <FormControl id="area" isRequired>
                ...
                <Input
                  ...
                  defaultValue={product.propArea}
                  onChange={(e) =>
                    setProduct({ ...product, propArea: e.target.value })
                  }
                />
              </FormControl>
            </Box>
            <Box>
              <Select
                ...
                onChange={(e) => {
                  setProduct({
                    ...product,
                    selectedPropertyUnit: e.target.value,
                  });
                }}
              >
                <option
                  value="Hilly Area"
                  selected={product.selectedPropertyUnit === "Hilly Area"}
                >
                  Hilly Area{" "}
                </option>
                <option
                  value="Terai Area"
                  selected={product.selectedPropertyUnit === "Terai Area"}
                >
                  Terai Area{" "}
                </option>
                <option
                  value="Standard sq meter/ft "
                  selected={
                    product.selectedPropertyUnit === "Standard sq meter/ft "
                  }
                >
          ...
          <SimpleGrid mt={5} columns={{ sm: 3, md: 4 }}>
            <Checkbox
              value="Drainage"
              defaultChecked={selectedData["Drainage"]}
            ...
            <Checkbox
              value="Drinking"
              defaultChecked={selectedData["Drinking"]}
            ...
            <Checkbox
              value="parking"
              defaultChecked={selectedData["parking"]}
            ...
            <Checkbox
              value="Dining "
              defaultChecked={selectedData["Dining"]}
            ...
            <Checkbox
              value="Kitchen"
              defaultChecked={selectedData["Kitchen"]}
            ...
            <Checkbox
              value="Bedroom"
              defaultChecked={selectedData["Bedroom"]}
            ...
            <Checkbox
              value="Earth"
              defaultChecked={selectedData["Earth"]}
          ...
          <FormControl id="oldpassword" isRequired mt={7}>
            ...
            <Textarea
              ...
              onChange={(e) =>
                setProduct({ ...product, propDesc: e.target.value })
              }
            />
          </FormControl>
          ...
          <HStack gap={5} align={"center"} mt={5}>
            <Box>
              <FormControl id="price" isRequired>
                ...
                <Input
                  type="text"
                  defaultValue={product.propPrice}
                  onChange={(e) =>
                    setProduct({ ...product, propPrice: e.target.value })
                  }
                />
              </FormControl>
            </Box>
            <Box>
              ...
              >
                <option
                  value="Per Month"
                  selected={product.selectedPropertyUnit === "Per Month"}
                >
                  Per Month{" "}
                </option>
                <option
                  value="Per Year"
                  selected={product.selectedPropertyUnit === "Per Year"}
                >
                  Per Year{" "}
                </option>
                <option
                  value="For Sale"
                  selected={product.selectedPropertyUnit === "For Sale"}
                >
                  For Sale{" "}
                </option>
              </Select>
